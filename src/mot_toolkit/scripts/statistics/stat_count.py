...
if __name__ == "__main__":
    base_path = r"H:\Datasets\TrackShipOnlineVideo\LabelMe\sea_video_20240313_part"
    result_list = \
        stat_count(base_path + "1")
    save_to_csv(result_list, "part1.csv")

    result_list = \
        stat_count(base_path + "2")
    save_to_csv(result_list, "part2.csv")

    result_list = \
        stat_count(base_path + "3")
    save_to_csv(result_list, "part3.csv")

    result_list = \
        stat_count(base_path + "4")
