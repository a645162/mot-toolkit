...
def process_sequence(
    ...
    video_out = cv2.VideoWriter(output_video_path, fourcc, fps, (final_width, final_height))
    ...
    for i, annotation in enumerate(tqdm.tqdm(annotation_directory.annotation_file_list)):
        frame_index = i + 1
